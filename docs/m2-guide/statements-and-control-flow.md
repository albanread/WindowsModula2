...
but back-end execution is still being wired. See [Memory & exceptions](memory-and-exceptions.md).

---
[NewM2 Guide home](index.md) · [Expressions & operators](expressions-and-operators.md) · [Procedures](procedures.md)
