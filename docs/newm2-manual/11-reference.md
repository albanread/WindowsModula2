...
[Objects & classes](08-objects-and-classes.md).
...
objects as `NIL` is to pointers; see [Objects & classes](08-objects-and-classes.md)).

**Procedures & functions** (registered in `analyze.rs`) — see
[The standard environment](09-standard-environment.md) for what each does:
...
| Object RTTI | `ISMEMBER` (and the `GUARD` statement — see [Objects & classes](08-objects-and-classes.md)) |
| Program | `HALT` `ASSERT` |
...
[The standard environment](09-standard-environment.md).
...
[Expressions & operators](05-expressions-and-operators.md).

---
[NewM2 Guide home](index.md) · [Lexical structure](02-lexical-structure.md) · [The standard environment](09-standard-environment.md)
