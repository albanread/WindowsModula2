...
procedure `HIGH` is described in [The standard environment](09-standard-environment.md). The
...
file. See [Modules & compilation](03-modules-and-compilation.md) for the definition/
...
types](04-declarations-and-types.md) page introduced the type form; here is the usage side.
...
---
[NewM2 Guide home](index.md) · [Statements & control flow](06-statements-and-control-flow.md) · [Modules & compilation](03-modules-and-compilation.md)
